...
/**
 * This class parses the PERMY data. A unit-conversion is performed from mD to
 * m^2 (SI).
 * <p>
 * See Eclipse Reference Manual 2004a, pp. 1240.
 */
public class Permy implements DataInputParser {
     ...
     * @throws EOFException
     */
    public Permy(StringInputStream input) throws EOFException, IOException {
    ...
    public void parse(StringInputStream input) throws IOException {
        ...
        config.putDoubleArray("permy", array);
    }
