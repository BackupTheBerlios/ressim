...
/**
 * This class parses the HZFIN keyword, see Eclipse Reference Manual 2004a, pp.
 * 894.
 */
public class Hzfin implements DataInputParser {
     ...
     * @throws IOException
     */
    public Hzfin(StringInputStream input) throws EOFException, IOException {
