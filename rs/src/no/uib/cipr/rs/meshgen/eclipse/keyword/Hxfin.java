...
/**
 * This class parses the HXFIN keyword, see Eclipse Reference Manual 2004a, pp.
 * 884.
 */
public class Hxfin implements DataInputParser {
     ...
     * @throws IOException
     */
    public Hxfin(StringInputStream input) throws EOFException, IOException {
    ...
    public void parse(StringInputStream input) throws IOException {
        ...
        config.putDoubleArray("hxfin", array);
    }
