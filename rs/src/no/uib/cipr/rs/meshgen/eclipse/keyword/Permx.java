...
/**
 * This class parses the PERMX data. A unit-conversion is performed from mD to
 * m^2 (SI).
 * <p>
 * See Eclipse Reference Manual 2004a, pp. 1238.
 */
public class Permx implements DataInputParser {
     ...
     * @throws EOFException
     */
    public Permx(StringInputStream input) throws EOFException, IOException {
    ...
    public void parse(StringInputStream input) throws IOException {
        ...
        config.putDoubleArray("permx", array);
    }
