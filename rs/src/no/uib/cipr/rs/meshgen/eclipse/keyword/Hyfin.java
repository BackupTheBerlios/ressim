...
/**
 * This class parses the HYFIN keyword, see Eclipse Reference Manual 2004a, pp.
 * 886.
 */
public class Hyfin implements DataInputParser {
     ...
     * @throws IOException
     */
    public Hyfin(StringInputStream input) throws EOFException, IOException {
    ...
    public void parse(StringInputStream input) throws IOException {
        ...
        config.putDoubleArray("hyfin", array);
    }
