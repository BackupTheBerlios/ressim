...
/**
 * This class parses the NXFIN keyword, see Eclipse Reference Manual 2004a, pp.
 * 1127.
 */
public class Nxfin implements DataInputParser {
     ...
     * @throws IOException
     */
    public Nxfin(StringInputStream input) throws EOFException, IOException {
    ...
    public void parse(StringInputStream input) throws IOException {
        ...
        config.putDoubleArray("nxfin", array);
    }
