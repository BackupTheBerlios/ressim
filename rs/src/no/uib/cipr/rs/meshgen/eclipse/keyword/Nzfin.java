...
/**
 * This class parses the NZFIN keyword, see Eclipse Reference Manual 2004a, pp.
 * 1131.
 */
public class Nzfin implements DataInputParser {
     ...
     * @throws IOException
     */
    public Nzfin(StringInputStream input) throws EOFException, IOException {
    ...
    public void parse(StringInputStream input) throws IOException {
        ...
        config.putDoubleArray("nzfin", array);
    }
