...
/**
 * Linear potential in the y-direction
 * 
 * @author nmaeo
 */
public class LinearY implements Function {
    ...
    public LinearY(@SuppressWarnings("unused")
    Configuration config, String name) {
        this(name, 3);
    }

    public LinearY(String name, int dimension) {
        this.name = name;
        this.dimension = dimension;
    }

    public LinearY(LinearY analyticalPotential) {
