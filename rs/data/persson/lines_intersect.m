...
function [pt] = lines_intersect (vertices, edge1, edge2)
  ...
  a = 1; b = 2; x = 1; y = 2;
  x_a_1 = vertices(edge1(a), x);
  y_a_1 = vertices(edge1(a), y);
  x_b_1 = vertices(edge1(b), x);
  y_b_1 = vertices(edge1(b), y);
  x_a_2 = vertices(edge2(a), x);
  y_a_2 = vertices(edge2(a), y);
  x_b_2 = vertices(edge2(b), x);
  y_b_2 = vertices(edge2(b), y);
